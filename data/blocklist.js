...
export const HARD_MESSAGE_PATTERNS = [
  ...
  rule("brand-suffix-token", /\b(?!timeslots?\b)[a-z]{2,}(?:toto|togel|slot)\d*\b/i, 5),
...
export const PROMO_MESSAGE_PATTERNS = [
  ...
  rule("site-pitch", /\bsitus\s+(?:lama|baru|alternatif|resmi|terbaik|terpercaya|gacor|pasti|tergacor|terbaru|aman)\b/i, 3),
