...
describe("wsProtocol/saweria", () => {
  ...
  test("parse returns donation array", () => {
    ...
    expect(r).toEqual([
      { donator: "bobby", message: "slot gacor", amount: 10000, currency: "IDR" },
    ]);
  });
...
describe("wsProtocol/bagibagi", () => {
  ...
  test("parse strips \\x1e and returns donation", () => {
    ...
    expect(r).toEqual([
      { donator: "alice", message: "depo qris wd", amount: 5000, currency: "IDR" },
    ]);
  });
...
describe("wsProtocol/sociabuzz", () => {
  ...
  test("parse extracts nested JSON donation", () => {
    ...
    expect(r).toEqual([
      { donator: "carla", message: "free spin klaim", amount: 25000, currency: "IDR" },
    ]);
  });
