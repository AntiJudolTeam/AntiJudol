...
const platforms = {
  saweria: {
    ...
    overlayUrl: ({ streamKey, overlayType = "alert" }) => `https://saweria.co/widgets/${overlayType}?streamKey=${streamKey}`,
  ...
  tako: {
    ...
    overlayUrl: ({ streamKey, overlayType = "alert" }) => `https://tako.id/overlay/${overlayType}?overlay_key=${streamKey}`,
